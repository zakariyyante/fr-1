export default function Logo({ className = "" }: { className?: string }) {
  return (
    <div className={`flex items-center gap-2 ${className}`}>
      {/* Icon: Crown + card suit composition */}
      <svg
        width="36"
        height="36"
        viewBox="0 0 36 36"
      ...
      >
        ...
        <defs>
          <linearGradient id="logo-bg" x1="0" y1="0" x2="36" y2="36" gradientUnits="userSpaceOnUse">
            ...
            <stop offset="100%" stopColor="#080815" />
          </linearGradient>
      ...
      <div className="flex flex-col leading-none">
        <span className="gold-text font-black text-xl tracking-tight">TopCasinos</span>
        <span className="text-white font-semibold text-xs tracking-widest uppercase opacity-80">France</span>
      </div>
    </div>
  );
}
